...
export const postSchema = ({ image }: SchemaContext) =>
  z.object({
    ...
    tags: z
      ...
      .default([])
      .describe(
        'Adds supporting keywords used for discovery and filtering. Structural classifications should use reportType, assetClass and sector.'
      ),
    reportType: z
      .enum([
        'Research Note',
      ...
      .describe('Classifies the format and analytical purpose of the report.'),

    assetClass: z
      .enum(['Commodities', 'Credit', 'Rates', 'FX', 'Multi-Asset'])
      .optional()
      .describe(
        'Defines the primary market or asset class covered by the report.'
      ),
    ...
    featured: z
      ...
      .default(false)
      .describe(
        'Controls whether the report is prioritised as featured research.'
      ),
    ...
    investmentView: z
      ...
      .optional()
      .describe(
        'Defines the directional investment view presented in the research report.'
      ),
    ...
    timeHorizon: z
      ...
      .optional()
      .describe(
        'Defines the expected time horizon for the investment thesis, such as `3–12 Months`.'
      ),
    ...
    drivers: z
      ...
      .default([])
      .describe(
        'Lists the principal factors expected to drive the investment thesis.'
      ),
